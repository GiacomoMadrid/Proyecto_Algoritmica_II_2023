 ...
 */
public class frmReadAttendance extends javax.swing.JFrame {

    /**
     * Creates new form frmReadAttendance
     */
    public frmReadAttendance() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("JEMS | Modulo de Asistencias");
        ...
        btnCreate.setText("Crear Asistencia");
        ...
        jLabel2.setText("Cod. Asistencia:");
        ...
        tblResult.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Nombre", "DNI", "Codigo de Asistencia", "Dia", "Hora de Registro", "Tipo de Registro", "Estado"
            }
        ) {
        ...
        tblResult.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
        ...
        txtRegistroHorarios.setText("MÓDULO DE ASISTENCIAS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReadAttendance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmReadAttendance().setVisible(true);
            }
        });
    }
